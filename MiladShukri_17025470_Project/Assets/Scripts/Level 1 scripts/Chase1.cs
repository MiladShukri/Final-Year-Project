...
public class Chase1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Vector3.Distance(player.position, this.transform.position) < 8)
        {
            ...
            if (direction.magnitude > 1)
            {
                ...
                // Sets the speed of the zombie when it starts to chase the player
    ...
    IEnumerator EnemyDamage()
    {
        ...
        // This controls how much damage the zombie does to the player
        GlobalHealth1.PlayerHealth -= 10;
