...
public class HeadScript1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (HeadHealth <= 0)
        {
            ...
            EnemyScript1.count = EnemyScript1.count + 1;
        }

        // This grabs the kill count components and updates it when the count is updated
        KillCount.GetComponent<Text>().text = "Kill Count: " + EnemyScript1.count + "/10";
