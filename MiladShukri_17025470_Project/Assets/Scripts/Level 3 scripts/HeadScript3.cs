...
public class HeadScript3 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (HeadHealth <= 0)
        {
            ...
            EnemyScript3.count = EnemyScript3.count + 1;    
        }

        // This grabs the kill count components and updates it when the count is updated
        KillCount.GetComponent<Text>().text = "Kill Count: " + EnemyScript3.count + "/10";
